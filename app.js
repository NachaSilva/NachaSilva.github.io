...
let aux=localStorage.getItem('palabras');
let palabras;
if(aux===null){
  palabras = [
    'PANDA','GORILA','CONCON','TIGRE','HUEMUL','LEON']
}
else{
...
function enviarPalabra(){
  ...
  let aux= JSON.parse(localStorage.getItem('palabras'));

  let inputTexto = document.querySelector(".input-palabra")
  aux.push(inputTexto.value);
  console.log(aux);
  localStorage.setItem("palabras",JSON.stringify(aux))
